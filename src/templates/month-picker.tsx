...
const monthPickerStyles = `
  ...
  .handwritten-datepicker .react-datepicker__header--custom {
  ...
  /* Specific styles for Month Picker Grid */
  .handwritten-datepicker .react-datepicker__month-wrapper {
    display: flex !important;
    justify-content: center !important;
  }
  .handwritten-datepicker .react-datepicker__month-text {
    font-family: 'Virgil', 'Caveat', cursive !important;
    color: #333333 !important;
  ...
  .handwritten-datepicker .react-datepicker__month-text:hover {
    background: rgba(51,51,51,0.07) !important;
    border-radius: 0 !important;
    text-decoration: underline wavy !important;
  }
  .handwritten-datepicker .react-datepicker__month-text--selected {
    background: #333333 !important;
    color: white !important;
    border-radius: 0 !important;
    font-weight: 700 !important;
  }
  .handwritten-datepicker .react-datepicker__month-text--keyboard-selected {
    background: rgba(51,51,51,0.15) !important;
  }
  .handwritten-datepicker .react-datepicker__month-text--disabled {
...
// ─── MonthPickerInput (trigger button) ─────────────────────────────────────────

interface MonthPickerInputProps extends React.HTMLAttributes<HTMLDivElement> {
  border?: 'rough' | 'normal';
  disabled?: boolean;
  value?: string;
}

const MonthPickerInput = React.forwardRef<
  HTMLDivElement,
        ...
        <div ref={ref} className={`handwritten-datepicker ${className}`.trim()}>
          {inline ? (
            ...
            <ReactDatePicker
              ...
              customInput={
                <MonthPickerInput border={border} disabled={disabled} />
              }
            />
          )}
        </div>
