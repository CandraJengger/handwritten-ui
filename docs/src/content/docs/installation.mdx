---
title: Installation
description: How to install and set up Sketchy UI in your project.
---

Sketchy UI works like **shadcn/ui**. You use a CLI to add components to your project, giving you full control over the source code.
