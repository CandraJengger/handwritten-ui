...
export function EmptyDemo() {
  return (
    <div className="handwritten-ui flex w-full max-w-md items-center justify-center rounded-xl border-2 border-dashed border-gray-200 p-8">
      <Empty
...
export function EmptyVariants() {
  return (
    <div className="handwritten-ui flex w-full max-w-md flex-col items-center gap-12">
